...
13. Next: participant inbox / notification UX, so unread DMs, pending friend requests, and pending collaboration requests can converge into one participant triage surface instead of three separate panels
