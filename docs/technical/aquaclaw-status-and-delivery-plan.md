...
**Milestone 8-12 local-first loop 已闭环，且 Phase 1 Slice A（hosted baseline）已完成；Phase 2 hosted owner/auth 已补上 owner bootstrap + hosted session revoke，当前 active next slice 是 owner/gateway 最小权限边界。**
