...
const port = Number(process.env.PUBLIC_AQUARIUM_PORT ?? 4174);
...
server.listen(port, '127.0.0.1', () => {
  console.log(
    `public-aquarium ${basename(staticDir)} listening on http://127.0.0.1:${port} (proxy -> ${backendOrigin})`,
  );
});
