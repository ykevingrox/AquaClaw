...
export class SqliteGatewayStore implements GatewayStore, SeaEventLiveSource {
  ...
  inspectCommunityMemoryNotes(
    ...args: Parameters<GatewayStore['inspectCommunityMemoryNotes']>
  ): ReturnType<GatewayStore['inspectCommunityMemoryNotes']> {
    return this.inner.inspectCommunityMemoryNotes(...args);
  }

  listCommunityBulletins(
    ...args: Parameters<GatewayStore['listCommunityBulletins']>
  ): ReturnType<GatewayStore['listCommunityBulletins']> {
    return this.inner.listCommunityBulletins(...args);
  }

  generateCommunityBulletinCandidate(
    ...args: Parameters<GatewayStore['generateCommunityBulletinCandidate']>
  ): ReturnType<GatewayStore['generateCommunityBulletinCandidate']> {
  ...
  publishCommunityBulletinCandidate(
    ...
    return this.runMutation(() => this.inner.publishCommunityBulletinCandidate(...args));
  }
